...
public class BusinessChallengesCommentsController {
	...
	@PostMapping("/challengecomments/{ideaId}")
	public ResponseEntity<BusinessChallengeComments> postComment(@PathVariable() String ideaId, @RequestBody BusinessChallengeComments commentRequest) {
		if(commentRequest != null) {
			...
			try {
				...
				BusinessChallenges challenge = challengesRepository.findById(ideaId).get();
