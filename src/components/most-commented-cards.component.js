...
class MostCommentedCardsComponent extends Component {
    ...
    componentDidMount() {
        IdeaService.getMostcommentedcards().then((res) => { this.setState({ ideas: res.data }); });
    }

    render() {
        return (
            <div>
                <div className="head"><h1 className="d-inline-flex display-6 cards-title">Most commented Ideas</h1></div>
...
export default MostCommentedCardsComponent;